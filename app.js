(function() {
    ...
    const filter = (source, query, kosher) => {
        ...
        return source.filter(i => i.toUpperCase().includes(needle)).map(i => {
            return {
                name: i,
                kosher: kosher
            };
